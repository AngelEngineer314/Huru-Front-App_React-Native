...
const InterviewListScreen = props => {
  const { onMoveScreen, previousItem, selectedItem, onVisibleModal } = props
  ...
  const filteredData = term // based on text, filter data and use filtered data
    ...
    : Interview; // on on text, u can return all data
    ...
    <View style={styles.item}>
      <View>
        <LinearGradient
          ...
          <TouchableOpacity
            onPress={() => onMoveScreen('interview', selectedItem, itemData.item.title)}
          >
          ...
          <TouchableHighlight>
            <View style={styles.mainView}>
              <View style={{paddingHorizontal: '5%'}}>
                ...
                <CategoryHeader onMoveScreen={onMoveScreen} screenName={screenName} moveScreen="subCategory" selectedItem={selectedItem} previousItem={previousItem}/>
...
InterviewListScreen.navigationOptions = () => {
  return {
    header: () => null,
  };
};
